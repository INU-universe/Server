...
import universe.universe.service.friend.FriendRequestImpl;
...
public class FriendRequestApiController {
    final private FriendRequestImpl friendService;
    ...
    public ResponseEntity<?> toggle(@PathVariable Long toUserId) {
        try {
            ...
            FriendRequestResponseDTO.FriendRequestToggleDTO friendRequestToggleDTO = friendService.toggle(userEmail, toUserId);
    ...
    public ResponseEntity<?> accept(@PathVariable Long toUserId) {
        try {
            String userEmail = getUserEmail();
            FriendRequestResponseDTO.FriendRequestAcceptDTO friendRequestAcceptDTO = friendService.accept(userEmail, toUserId);
    ...
    public ResponseEntity<?> reject(@PathVariable Long toUserId) {
        try {
            String userEmail = getUserEmail();
            FriendRequestResponseDTO.FriendRequestRejectDTO friendRequestRejectDTO = friendService.reject(userEmail, toUserId);
